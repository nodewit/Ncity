...
layui.config({
	...
	var form = layui.form,
		...
		tab = layui.bodyTab({
			...
			url : "/view/system/getUserInfo" //获取菜单json地址
		});
		
		$.ajax({ 
			url: "/view/system/getUserInfo",
			async:false,
			dataType:"json",
	...
	function showNotice(){
		layer.open({
	        ...
	        btn: ['火速围观'],
	        moveType: 1,
	        content: '<div style="padding:15px 20px; text-align:justify; line-height: 22px; text-indent:2em;border-bottom:1px solid #e2e2e2;"><p>springboot+redis权限框架v1.0</p></div>',
